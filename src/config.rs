//! scout application configuration — backed by library's `AppConfig<T>`.
//!
...
pub const CONFIG_HEADER: &str = "scout Local Configuration\n----------------------------";

/// Concrete configuration fields for scout.
#[derive(Debug, Clone)]
